...
const DESCRIPTION_TEMPLATE = `<div itemscope="" itemtype="https://schema.org/Product" style="max-width: 700px; margin: 0px auto; background: rgb(255, 255, 255); padding: 12px 4px; box-sizing: border-box;">
  ...
  <p style="color: red; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: bold; margin: 0px 0px 14px; line-height: 1.75;">In the United States, import duties are applied regardless of the value of the goods. In addition, for shipments to EU member states, import duties apply to goods valued at EUR150 or less.</p>
  <p style="color: red; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: bold; margin: 0px 0px 18px; line-height: 1.75;">For purchases from our store, we collect these import duties and the related customs handling fees as part of the Shipping Charge. As a result, customers in the United States and EU member states should not normally be required to pay additional import duties or customs-related fees at the time of customs clearance or delivery.</p>
